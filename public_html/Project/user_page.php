...
<body>
		<table cellpadding='3' cellspacing='3' class='tab_main'>
			...
			/* password hashing compatability */
		...
		return $data;
			...
			$query="select * from hash_students where email='$email'";
			...
			include 'mysql.php';
				...
				$array=MySQLi_Fetch_Assoc($result);
					/* if query result wasnt empty AND password is verified */
					if($array && password_verify($password, $array["hash"])) {
						//Session_start();
						$_SESSION["user_id"] = $array["id"]; 
						$user_here = $_SESSION["user_id"];
						$_SESSION["name"] = $array["name"];
						$_SESSION["password"] = $password;
						$_SESSION["hash"] = $array["hash"];
						...
						<!--echo "<tr align='center' id='sam'> <td colspan='5'> <font color='lightgreen'>Login Successful, ".$_SESSION["name"]."! </font> </td> </tr>"; -->
						<?php }
						echo "<tr> 
						<td width='5%' valign='top'> 
							<table>
								...
								<tr align='center' bgcolor='lightgrey' class='td_bor'>
									<td width='5%'> <a href='games.php'>Shadow Tag</a></td></tr>
							</table>
						</td>
				...
				<td colspan='4'>";
						...
						while(($rows=MySQLi_Fetch_Row($count))==True) {
							...
							$queryx = "select name from hash_students where id = $rows[0]";
							$result = MySQLi_Query($resid,$query);
